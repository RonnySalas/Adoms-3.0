...
// Register Method
export const postRegister = (data, headers) => api.create(url.POST_REGISTER, data, headers);

// Login Method
export const postLogin = (data, headers) =>
...
// get Orders
export const getOrders = (headers) => api.get(url.GET_ORDERS, headers);
