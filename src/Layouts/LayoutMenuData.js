    ...
    const menuItems = [
        ...
        },
        {
            ...
            subItems: [
                ...
                { id: "gridjs", label: "Grid Js", link: "#", parentId: "tables" },
                { id: "listjs", label: "List Js", link: "#", parentId: "tables" },
                { id: "datatables", label: "Datatables", link: "#", parentId: "tables" },
            ],
        },
        {
            id: "charts",
            ...
            subItems: [
                {
                    ...
                    childItems: [
                        ...
                        { id: 7, label: "Candlstick", link: "#" },
                        { id: 8, label: "Boxplot", link: "#" },
                        { id: 9, label: "Bubble", link: "#" },
                        { id: 10, label: "Scatter", link: "#" },
                        { id: 11, label: "Heatmap", link: "#" },
                        { id: 12, label: "Treemap", link: "#" },
                        { id: 13, label: "Pie", link: "#" },
                        { id: 14, label: "Radialbar", link: "#" },
                        { id: 15, label: "Radar", link: "#" },
                        { id: 16, label: "Polar Area", link: "#" },
                    ]
                },
        ...
        },
        {
            ...
            subItems: [
                ...
                { id: "crypto", label: "Crypto SVG", link: "#", parentId: "icons", badgeName: "New", badgeColor: "danger" },
            ],
        },
        {
            id: "maps",
